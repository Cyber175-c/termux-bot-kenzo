...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:Kenzo\n'
            + 'ORG:Creator KENZOBOT;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6282159384782:+62 821-5938-4782\n'
            + 'END:VCARD'

prefix = '.'
ig = 'https://www.instagram.com/kenzo.doafe'
name = '~ K E N Z O B O T'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["6282159384782@s.whatsapp.net"]
...
//creator
			...
			if (args.length < 1) return reply(`${name} Harus Nulis Apa Kak??`)
                ...
                tahta = `${body.slice(8)}`
                     ...
                     if (arga.length > 10) return reply('karakter minimal 10')
